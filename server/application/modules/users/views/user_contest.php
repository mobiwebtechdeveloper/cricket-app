                ...
                <div class="ibox-content">
                 <div class="row">
                    ...
                    <div class="col-lg-12" style="overflow-x: auto">
                        <h3 class="text-success"><a class="text-danger" onclick="window.history.back();"><i class="fa fa-arrow-circle-o-left"></i>BACK</a> User Private Contest => <?php echo ucwords($users->first_name).' ('.$users->email;?>)</h3>   
                    <table class="table table-bordered table-responsive" id="common_datatable_users_contest">
                        <thead>
                            <tr>
                                <th>ID</th>
                                <th>Contest Name</th>
